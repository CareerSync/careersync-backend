...
//                                .toList();
        ...
        // Select a subset of 3 job posts for the response
        List<JobPost> jobPostsForResponse = jobPosts.stream().limit(3).toList();
        ...
        // Return response DTO with only 3 job posts
        return createChatResponseDto(questionStr, answerStr, jobPostsForResponse, isFirstChat);
    }
