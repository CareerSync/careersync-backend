...
public enum BaseResponseStatus {
    ...
    POST_REPORT_EXISTS_USER_AND_BOARD(false,HttpStatus.BAD_REQUEST.value(),"중복된 신고 내역입니다."),
    ...
    INVALID_SUBSCRIPTION(false, HttpStatus.NOT_FOUND.value(), "존재하지 않는 구독 내역입니다."),
